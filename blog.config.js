...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '你好！欢迎来到Yeiiing的个人空间！！！',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Yeiiing', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通人的生活记录。因为值得，所以记录。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://Yeiiing.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '博客,个人空间', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '2522625311@qq.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://img.zcool.cn/community/01df2f5a8b99c8a8012045b3c93462.jpg@1280w_1l_2o_100sh.jpg', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    ...
    {
      name: 'shootout（Slowed ）',
      artist: 'sin',
      url: 'https://music.163.com/#/song?id=2003298390',
      cover:
            'http://p1.music.126.net/SMaa7nDOS8Qamr6FrObLfA==/109951168108064313.jpg?param=130y130'
    },
    {
      name: '王都グランセル',
